...
address = 'mzAUD2byjNSJ2VwixnxG5QFDgxcGaBLydv'
print(f"🔍 Verificando saldo do novo endereço: {address}")
...
try:
    ...
    if response.status_code == 200:
        ...
        print(f"   UTXOs: {data.get('chain_stats', {}).get('funded_txo_count', 0)}")
        ...
        if utxo_response.status_code == 200:
            ...
            if confirmed_utxos:
                ...
                print(f"   ⚠️  Nenhum UTXO confirmado - precisa de fundos!")
        else:
